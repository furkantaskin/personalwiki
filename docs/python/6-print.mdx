...
2. İlk örneği ilerletip Londra, Berlin, Pekin ve Hant's Harbour için yerel saatleri yazsın ve bunu tek bir `print()` fonksiyonu içinde yapsın
  1. Londra: Bizden 3 saat geride (GMT)
  2. Almanya: Bizden 2 saat geride (GMT+1)
  3. Pekin: Bizden 5 saat ileride (GMT+8)
  4. Hant's Harbour: Bizden 5 saat 30 dakika geride (GMT -2:30)
